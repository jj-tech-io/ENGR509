...
def simulator_2d(options, KalmanFilter):
    ...
    for t0 in t:
        ...
        if True:#t0%1.0 == 0.0:
            ...
            x_est_data += [kalman_filter.measure_update(state_with_noise, t0)]
            if CONTROL_INPUTS:
    ...
    est, = ax.plot([], [], 'bs', markersize=10, fillstyle='none', linewidth=10)
    meas, = ax.plot([], [], 'gs', markersize=10, fillstyle='none', linewidth=10)
    ...
    car_zoom, = axins.plot([], [], 'r-', linewidth = 5)
    est_zoom, = axins.plot([], [], 'bs', markersize=35, fillstyle='none', linewidth=10)
    meas_zoom, = axins.plot([], [], 'gs', markersize=35, fillstyle='none', linewidth=10)
    ...
    car_ani = animation.FuncAnimation(fig, update_plot,
                                      ...
                                      repeat=False,
                                      blit=False)
    # car_ani.save('kf_2d_tracking.mp4')
